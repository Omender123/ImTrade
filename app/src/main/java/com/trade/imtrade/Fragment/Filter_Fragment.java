...
FragmentFilterBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.PriceShow.setOnClickListener(this);
        binding.PriceUnshow.setOnClickListener(this);
        binding.categorieShow.setOnClickListener(this);
        binding.categorieUnshow.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.Rating_unshow:
                ...
                break;
            case R.id.Price_show:
                binding.PriceShow.setVisibility(View.GONE);
                binding.PriceUnshow.setVisibility(View.VISIBLE);
                binding.layoutSeekbar.setVisibility(View.VISIBLE);
                break;

            case R.id.Price_unshow:
                binding.PriceShow.setVisibility(View.VISIBLE);
                binding.PriceUnshow.setVisibility(View.GONE);
                binding.layoutSeekbar.setVisibility(View.GONE);

                break;

            case R.id.categorie_show:
                binding.categorieShow.setVisibility(View.GONE);
                binding.categorieUnshow.setVisibility(View.VISIBLE);
                binding.textCategories.setVisibility(View.VISIBLE);
                break;

            case R.id.categorie_unshow:
                binding.categorieShow.setVisibility(View.VISIBLE);
                binding.categorieUnshow.setVisibility(View.GONE);
